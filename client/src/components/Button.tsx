...
const Button = ({
	...
	const twClass = twJoin(
		...
		color === 'primary' &&
			'border-2 border-red-500 dark:border-slate-900 bg-red-500 dark:bg-slate-900 text-white',
		color === 'secondary' &&
			'border-2 border-red-500 dark:border-slate-900 bg-white dark text-red-500 dark:text-slate-800',
		color === 'tertiary' &&
